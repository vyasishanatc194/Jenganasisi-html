...
// accordian
  ...
  $(".collapse.show").each(function(){
    $(this).prev(".card-header").find(".fe").addClass("fe-minus").removeClass("fe-plus");
  });
  
  // Toggle plus minus icon on show hide of collapse element
  $(".collapse").on('show.bs.collapse', function(){
    $(this).prev(".card-header").find(".fe").removeClass("fe-plus").addClass("fe-minus");
  }).on('hide.bs.collapse', function(){
    $(this).prev(".card-header").find(".fe").removeClass("fe-minus").addClass("fe-plus");
  });
...
$(".compare-check").change(function() {
    if($(this).is(":checked")) {
        ...
        setTimeout(function(){ $(".compare-footer-section").hide(300);}, 500);
    }
});
